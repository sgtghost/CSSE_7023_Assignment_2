...
public abstract class Aircraft implements OccupancyLevel, Tickable, EmergencyState {
     ...
     * After calling {@code unload()}, {@link #calculateOccupancyLevel()} should return 0
     ...
     * <ul>
     * <li>have the same callsign</li>
     * <li>have the same characteristics (AircraftCharacteristics)</li>
     * </ul>
    ...
    public boolean equals(Object obj) {
        ...
        return this.getCallsign().equals(aircraft.getCallsign())
                && this.getCharacteristics().equals(aircraft.getCharacteristics());
    }

    /**
     * Returns the hash code of this aircraft.
     * Two aircraft that are equal according to {@code equals(Object)}
     * should have the same hash code.
     * @return hash code of this aircraft
     */
    @Override
    public int hashCode() {
        return this.getCharacteristics().hashCode() * this.getCallsign().hashCode();
    }

    /**
     * Returns the machine-readable string representation of this aircraft.
     * The format of the string to return is
     *{@code callsign:model:taskListEncoded:fuelAmount:emergency}
     * where:
     * <ul>
     ...
     *
     * For example:
     * {@code ABC123:AIRBUS_A320:AWAY,AWAY,LAND,WAIT,LOAD@50,TAKEOFF,AWAY:3250.00:false}
