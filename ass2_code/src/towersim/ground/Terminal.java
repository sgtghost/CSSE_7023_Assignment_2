...
public abstract class Terminal implements EmergencyState, OccupancyLevel {
     ...
     * <ul>
     * <li>be the same type (i.e. the same concrete subclass of Terminal)</li>
     * <li>have the same terminal number</li>
     * </ul>
    ...
    public boolean equals(Object obj) {
        ...
        return this.getClass().getSimpleName().equals(terminal.getClass().getSimpleName())
                && this.getTerminalNumber() == terminal.getTerminalNumber();
    }

    /**
     * Returns the hash code of this terminal.
     * Two terminals that are equal according to {@code equals(Object)}
    ...
    @Override
    public int hashCode() {
        return this.getTerminalNumber() * this.getClass().getSimpleName().hashCode();
    }
     ...
     * The format of the string to return is
     * <ul>
     * <li>{@code TerminalType} is the simple class name of this terminal,
     * e.g. {@code AirplaneTerminal}</li>
     * <li>{@code terminalNumber} is the terminal number of this terminal</li>
     * <li>{@code emergency} is whether or not this terminal is in a state of emergency</li>
     * <li>{@code numGates} is the number of gates in this terminal</li>
     * <li>{@code encodedGateX} is the encoded representation of the Xth gate in this terminal,
     * for X between 1 and N inclusive, where N is the number of gates,
     * in the same order as returned by {@code getGates()}</li>
     * </ul>
     *
     * For example:
     * {@code HelicopterTerminal:3:false:0}
     * For example:
     * {@code AirplaneTerminal:1:true:3}
     * {@code 1:empty}
     * {@code 2:ABC123}
     * {@code 3:empty}
    ...
    public String encode() {
        ...
        String headLine =  String.format("%s:%d:%s:%d",
                this.getClass().getSimpleName(),
                this.terminalNumber,
                this.hasEmergency(),
                this.gates.size());
