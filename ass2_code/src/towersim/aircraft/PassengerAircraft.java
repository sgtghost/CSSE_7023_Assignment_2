...
public class PassengerAircraft extends Aircraft {
     ...
     *{@code callsign:model:taskListEncoded:fuelAmount:emergency:numPassengers}
     * where:
     * <ul>
     ...
     * <li>{@code numPassengers} is the number of passengers currently onboard the aircraft</li>
     * </ul>
     *
     * For example:
     * {@code ABC123:AIRBUS_A320:AWAY,AWAY,LAND,WAIT,LOAD@50,TAKEOFF,AWAY:3250.00:false:76}
